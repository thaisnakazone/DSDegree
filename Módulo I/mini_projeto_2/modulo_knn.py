class ClassificaPerfil:
    ...
    '''
    Criou-se um dicionário vazio, como atributo estático, que armazenará, a cada iteração do comando "for" 
    (no arquivo mini_projeto_2.ipynb), o resultado do conjunto de instruções da classe "ClassificaPerfil" 
    (ou seja, esse dicionário armazenará a classificação do perfil dos clientes com carteiras não treinadas).
    '''
    ...
    def __init__(self, data, no_class, k, ind_no_class):
        ...
        - lista_dist_ord (uma lista vazia que armazenará o resultado do conjunto de instruções do método "calcula_dist");
        - dicio_freq_perfil (um dicionário vazio que armazenará o resultado do conjunto de instruções do método "freq_perfil_menores_dist").
        '''
        self.data = data
    ...
    def freq_perfil_menores_dist(self):
        ...
        Este método recebe os seguintes argumentos (self), já definidos no método construtor:
        - self.k;
        - self.lista_dist_ord (o retorno do método anterior, ou seja, a lista com as 120 distâncias).
    ...
    def classifica_perfil(self):
        ...
        - self.k;
        - self.ind_no_class;
        - self.dicio_freq_perfil (o retorno do método anterior, ou seja, o dicionário com a frequência do perfil dos 5 clientes com as
        distâncias mais próximas).
        Esse método busca, em "self.dicio_freq_perfil", o perfil que obteve uma frequência maior do que a metade do valor de k 
        (ou seja, o perfil que obteve a maior frequência na lista dos 5 clientes com as distâncias mais próximas) e, então, 
        classifica o cliente com uma carteira não treinada, armazenando essas informações em outro dicionário (dicio_perfil_classificado).
        Depois, retorna-se esse dicionário (dicio_perfil_classificado), em que a chave é o CPF do cliente e o valor é o perfil classificado.
        '''
    ...
    def mostra_classificacao():
        ...
        (dicio_perfil_classificado) foi criado como um atributo estático da classe "ClassificaPerfil".
        Por fim, retorna-se esse dicionário com os 30 perfis classificados.
        '''
        return ClassificaPerfil.dicio_perfil_classificado